...
BODY="{\"AttachStdin\": false, \"AttachStdout\": true, \"AttachStderr\": true, \"Tty\": false, \"Cmd\": [\"bash\",\"-c\",\"/usr/bin/pure-pw userdel d-$1 -f /etc/pure-ftpd/passwd/pureftpd.passwd -m\"] }"
echo $BODY > /tmp/payload_remove_download_$1.json
