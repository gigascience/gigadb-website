...
# Use database env variables in .secrets
set -a
...
usage="$(basename "$0") [-h] [-i o] -- program to export table data from GigaDB PostgreSQL database as CSV files
...
PGPASSWORD=$EXPORT_CSV_GIGADB_PASSWORD psql -h $EXPORT_CSV_GIGADB_HOST -p $EXPORT_CSV_GIGADB_PORT -U $EXPORT_CSV_GIGADB_USER $EXPORT_CSV_GIGADB_DB <<EOF
