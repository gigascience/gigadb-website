...
Scenario: The page at the unique and time-limed url show uploaded files, attributes, samples and download links
	...
	| seq1.fa | Sample A, Sample Z | Sequence assembly | FASTA | 23.43 MiB | growth temperature: 45 | MD5 checksum: 90|
	| Specimen.pdf | Sample E | Annotation | PDF | 19.11 KiB | growth temperature: 51 | MD5 checksum: 75|
