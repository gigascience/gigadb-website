...
Scenario: Triggering the creation of a drop box for a dataset with the appropriate status
	...
	Then I should see "A new drop box has been created for the dataset 000005."
...
@ok
Scenario: Seeing Popup composer for customizing and sending email instructions
	Given I sign in as an admin
	And I go to "/site/admin"
	When I press "Datasets"
	And I press "New Dropbox for this dataset"
...
# 	And I should not see a "Assign Drop box to dataset 000005" button
