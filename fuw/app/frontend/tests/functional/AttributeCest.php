...
class AttributeCest
{
    ...
    public function testAddAttributes(FunctionalTester $I)
    {
        ...
        $example = [
            1 => [
                    "Attributes" => [
                        0 => ["name" => "Temperature", "value" => "45", "unit" => "Celsius", "upload_id" => 1],
                        1 => [ "name" => "Humidity","value" => "75", "unit" => "%", "upload_id" => 1],
                        2 => ["name" => "Age","value" => "33", "unit" => "Years", "upload_id" => 1],
                    ]
                ],
            2 => [
                    "Attributes" => [
                        0 => [ "name" => "Contrast","value" => "3000", "unit" => "Nits", "upload_id" => 1],
                    ]
                ], 
        ];
        $I->amBearerAuthenticated("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..uTZpDB1eCGt3c_23wLaVxpFUw_WFH2Jep_vpzky2o18");
        $I->sendPOST("/attributes", $example[1]);
        $I->seeResponseCodeIs(200);
        $I->seeResponseIsJson();
        $I->canSeeResponseContainsJson(
            ["name" => "Temperature", "value" => "45", "unit" => "Celsius", "upload_id" => 1]
