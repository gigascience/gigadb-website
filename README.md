...
[![Chat on Matrix](https://matrix.to/img/matrix-badge.svg)](https://matrix.to/#/#gigascience_community:gitter.im)
...
Detailed instructions for setting up a development environment is at [Setup Guide](docs/sop/LOCAL_SETUP.md).
