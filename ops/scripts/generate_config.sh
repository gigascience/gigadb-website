...
SOURCE=${APP_SOURCE}/gigadb/app/tools/dataset-backup-tool/config/create_bucket.sh.dist
TARGET=${APP_SOURCE}/gigadb/app/tools/dataset-backup-tool/scripts/create_bucket.sh
VARS='$TENCENTCLOUD_SECRET_ID:$TENCENTCLOUD_SECRET_KEY:$TENCENTCLOUD_APP_ID'
envsubst $VARS < $SOURCE > $TARGET
chmod 755 ${APP_SOURCE}/gigadb/app/tools/dataset-backup-tool/scripts/create_bucket.sh

SOURCE=${APP_SOURCE}/gigadb/app/tools/dataset-backup-tool/config/delete_bucket.sh.dist
...
SOURCE=${APP_SOURCE}/gigadb/app/tools/dataset-backup-tool/config/cos.conf.dist
TARGET=${APP_SOURCE}/gigadb/app/tools/dataset-backup-tool/config/cos.conf
VARS='$TENCENTCLOUD_SECRET_ID:$TENCENTCLOUD_SECRET_KEY:$TENCENTCLOUD_APP_ID'
envsubst $VARS < $SOURCE > $TARGET
...
SOURCE=${APP_SOURCE}/gigadb/app/tools/dataset-backup-tool/config/variables.dist
TARGET=${APP_SOURCE}/gigadb/app/tools/dataset-backup-tool/config/variables
VARS='$TENCENTCLOUD_APP_ID'
envsubst $VARS < $SOURCE > $TARGET
