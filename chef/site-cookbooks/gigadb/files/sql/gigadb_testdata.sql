...
--
DROP TABLE IF EXISTS "YiiSession" CASCADE;
...
--
DROP TABLE IF EXISTS "alternative_identifiers" CASCADE;
...
--
DROP TABLE IF EXISTS "dataset_author" CASCADE;
...
--
DROP TABLE IF EXISTS "dataset_log" CASCADE;
...
--
DROP TABLE IF EXISTS "dataset_project" CASCADE;
...
--
DROP TABLE IF EXISTS "dataset_sample" CASCADE;
...
--
DROP TABLE IF EXISTS "dataset_session" CASCADE;
...
--
DROP TABLE IF EXISTS "exp_attributes" CASCADE;
...
--
DROP TABLE IF EXISTS "extdb" CASCADE;
CREATE TABLE extdb (
    id integer NOT NULL,
...
--
DROP TABLE IF EXISTS "external_link" CASCADE;
...
--
DROP TABLE IF EXISTS "external_link_type" CASCADE;
...
--
DROP TABLE IF EXISTS "file_attributes" CASCADE;
...
--
DROP TABLE IF EXISTS "file_experiment" CASCADE;
...
--
DROP TABLE IF EXISTS "file_relationship" CASCADE;
...
--
DROP TABLE IF EXISTS "file_sample" CASCADE;
...
--
DROP TABLE IF EXISTS "funder_name" CASCADE;
...
--
DROP TABLE IF EXISTS "gigadb_user" CASCADE;
...
--
DROP TABLE IF EXISTS "rss_message" CASCADE;
...
--
DROP TABLE IF EXISTS "sample_attribute" CASCADE;
...
--
DROP TABLE IF EXISTS "sample_experiment" CASCADE;
...
--
DROP TABLE IF EXISTS "sample_rel" CASCADE;
...
--
DROP TABLE IF EXISTS "schemup_tables" CASCADE;
...
91	210	Additional file Pygoscelis_adeliae.pep.gz added	2016-05-11 01:21:58.034232	File	88256	/adminFile/update/id/88256
92	210	Additional file Pygoscelis_adeliae.RepeatMasker.out.gz added	2016-05-11 01:24:16.454904	File	88257	/adminFile/update/id/88257
...
112	Readme	Stuff
113	Sequence assembly	Stuff
114	Annotation	Stuff
115	Protein sequence	Stuff
116	Repeat sequence	Stuff
117	Coding sequence	Stuff
118	Script	Stuff
119	Mixed archive	Stuff
\.
...
41	FASTA	A text-based format which begins with a single-line description, followed by lines of sequence data
...
45	ENA                 	http://www.ebi.ac.uk/ena/data/view/	EBI
46	SRA                 	http://www.ncbi.nlm.nih.gov/sra?term=	NCBI
\.
