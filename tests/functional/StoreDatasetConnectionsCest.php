...
class StoreDatasetConnectionsCest
{
    ...
    public function tryViewTheDatasetPageWithNotFoundIdentifier(FunctionalTester $I)
    {
        ...
        $I->assertEquals("Supporting scripts and data for \"Investigation into the annotation of protocol sequencing steps in the Sequence Read Archive\".", $I->grabTextFrom('h1'));
