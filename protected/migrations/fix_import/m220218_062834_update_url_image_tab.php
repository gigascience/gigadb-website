...
class m220218_062834_update_url_image_tab extends CDbMigration
{
	public function safeUp()
	{
	    ...
	    Yii::app()->db->createCommand("update image set url = 'https://assets.gigadb-cdn.net/images/datasets/no_image.png' where url is null and location like 'no_image%';")->execute();
	}
