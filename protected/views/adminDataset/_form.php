                                    ...
                                    echo CHtml::ajaxButton(
                                        ...
                                        [
                                            ...
                                            'success' => new CJavaScriptExpression('function(output) {
                                                ...
                                                } else if (output.check_doi_status == 404 && output.create_md_status == 422 && output.create_doi_status == 422) {
                                                ...
                                                } else if (output.check_doi_status == 404 || output.check_doi_status == 200) {
