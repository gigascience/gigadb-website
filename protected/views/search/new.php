    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 search-filter-sidebar">
                <h2 class="search-result-title">Search result for <span
                        class="search-result-keyword"><i><?php echo $model->keyword ?></i></span></h2>
            ...
            <div class="col-xs-12 col-sm-8 search-results">
