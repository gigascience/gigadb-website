        ...
        <div class="filter">
            ...
            <div class='filter-content' style="<?= $model->common_name ? 'display:block;': 'display:none;'?>">
                ...
                <div class="options <? if(empty($model->common_name)) echo 'disabled'; ?> ">
                    <? echo MyHtml::checkBoxList("common_name",$model->common_name, CHtml::listData($list_common_names, 'id', 'common_name'),array('class'=>'common_name')); ?>
                </div>
            </div>
        </div>
        <div class="filter">
        ...
        <div class="filter">
            ...
            <div class='filter-content' style="<?= $model->project ? 'display:block;': 'display:none;'?>">
                ...
                <div class="options <? if(empty($model->project)) echo 'disabled'; ?>">
                    <?  echo MyHtml::checkBoxList("project",$model->project, CHtml::listData($list_projects, 'id', 'name'),array('class'=>'project'));?>
                </div>
            </div>
        </div>
        <div class="filter">
            ...
            <div class='filter-content' style="<?= $model->external_link_type ? 'display:block;': 'display:none;'?>">
                ...
                <div class="options <? if(empty($model->external_link_type)) echo 'disabled'; ?>">
                    <?  echo MyHtml::checkBoxList("external_link_type",$model->external_link_type, CHtml::listData($list_ext_types, 'id', 'name'),array('class'=>'external_link_type'));?>
                </div>
            </div>
        </div>
        ...
        <div class="filter" >
            ...
            <div class='filter-content' style="<?= $model->file_type ? 'display:block;': 'display:none;'?>">
                ...
                <div class="options <? if(empty($model->file_type)) echo 'disabled'; ?>">
                    <?  echo MyHtml::checkBoxList("file_type",$model->file_type, CHtml::listData($list_filetypes, 'id', 'name'),array('class'=>'file_type')); ?>
                </div>
            </div>
        </div>
        <div class="filter">
            ...
            <div class='filter-content' style="<?= $model->file_format ? 'display:block;': 'display:none;'?>">
                ...
                <div class="options <? if(empty($model->file_format)) echo 'disabled'; ?>">
                    <? echo MyHtml::checkBoxList("file_format",$model->file_format, CHtml::listData($list_formats, 'id', 'name'),array('class'=>'file_format'));?>
                </div>
            </div>
        </div>
        <div class="filter">
