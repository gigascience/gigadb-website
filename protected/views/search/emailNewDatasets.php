			    ...
			    <table cellpadding="0" cellspacing="0" border="0" align="center" width="600" style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; color: #6f6f6f;">
					...
					<tr>
					    <td width="600" bgcolor="#ffffff" style="padding-left:40px;padding-right:40px;line-height:20px;padding-bottom:10px;">
					    	<h2 style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#626262; font-size:24px; font-weight:200;padding-top:10px;">We have <? if (isset($listDataset)) echo count($listDataset); else echo 0;?> new datasets.</h2>
					      	<p style="color:#626262; font-size:15px; font-weight:200;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;">
					      		<? if (isset($listDataset)) ?>
						      		<? foreach ($listDataset as $key => $dataset) {
						            $url = Yii::app()->params['home_url']."/dataset/".$dataset->identifier;
						            echo '10.5524/'.$dataset->identifier.': ';
						            echo '<b><a href="'.$url.'">'.$dataset->title.'</a> </b>'.'<br/>';
						            } ?>
					      	</p>
						</td>
					</tr>
