            ...
            ?>
                ...
                <tr>
                    ...
                    ?>
                        ...
                        <td class="left">
                            <?= CHtml::activeDropDownList($file, '[' . $i . ']code', $samples_data, array('class' => 'span2')); ?>
                        </td>
                        <td class="left">
                            <?= CHtml::activeDropDownList($file, '[' . $i . ']type_id', CHtml::listData(FileType::model()->findAll(), 'id', 'name'),array('class'=>'span2')); ?>
                        </td>
                        <td>
                            <?= CHtml::activeDropDownList($file, '[' . $i . ']format_id', CHtml::listData(FileFormat::model()->findAll(), 'id', 'name'),array('class'=>'autowidth')); ?>
                        </td>
                        <td>
                            <?= CHtml::encode($file->getSizeWithFormat()) ?>
                        </td>
                        <td>
                            <?php echo $form->textArea($file, '[' . $i . ']description', array('rows' => 3, 'cols' =>30,'style'=>'resize:none')); ?>
                        </td>
                        <td>
                            <?php echo CHtml::submitButton("Update", array('class' => 'update btn', 'name' => $i)); ?> </td>
                </tr>
                <?
                $i++;
            }
...
<div>
    ...
    <table class="ex-table">
        ...
        <tr>
            <td>Sample_1.fasta</td>
            <td>1</td>
            <td>geomic</td>
            <td>fasta</td>
            <td>the filtered and clipped reads of sample 1</td>
        </tr>
    </table>
