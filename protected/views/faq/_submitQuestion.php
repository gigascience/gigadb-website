...
<div class="panel-group">
    <div class="panel panel-default js-panel-always-visible" id="contactPanel">
        <div class="panel-heading">
            <h2 class="h4 panel-title" id="headingContact">
                <button data-toggle="collapse" data-parent="#accordion" data-target="#panelContact" aria-expanded="<?php echo $hasValidationErrors ? 'true' : 'false'; ?>" aria-controls="panelContact">&nbsp;Can't find what you're looking for?</button>
            </h2>
        </div>
