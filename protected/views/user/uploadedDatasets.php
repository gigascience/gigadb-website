    ...
    <div class="table-responsive">
        ...
        <tbody>
            ...
            <tr class="<?php echo $class; ?>" id="js-dataset-row-<?=$data[$i]->id?>">
                ...
                if (!in_array($upload_status, ['Published', 'Private'])) { ?>
                ...
                <? } ?>
                    ...
                    <td>
                        <? if (!in_array($data[$i]->upload_status, ['Published', 'AuthorReview', 'Private'])){ ?>
                            <div>
                                <a class='update btn btn-transparent tooltip-trigger' data-toggle='tooltip'
                                   title='Update the metadata of the dataset'
                                   href=<? echo '/datasetSubmission/datasetManagement/id/' . $data[$i]->id ?>>Update<br/>dataset</a>
