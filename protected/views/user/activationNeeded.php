...
<?=Yii::t('app' , 'Click')?> <?= CHtml::link(Yii::t('app' ,"here"), array("user/sendActivationEmail", 'id'=>$user->id)) ?> <?=Yii::t('app' , 'to resend the email')?>
<?=Yii::t('app' , 'or') ?> <?= CHtml::link(Yii::t('app' ,"contact us"), "mailto:" . Yii::app()->params['support_email']) ?>&nbsp;
