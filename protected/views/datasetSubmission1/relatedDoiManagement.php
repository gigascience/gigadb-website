...
<div class="span12 form well">
	...
	<div id="author-grid" class="grid-view">
     ...
     <div class="span12" style="text-align:center">
        <a href="/datasetSubmission/exLinkManagement/id/<?= $model->id ?>" class="btn-green">Previous</a>
        ...
        <a href="/datasetSubmission/SampleManagement/id/<?= $model->id ?>" class="btn-green">Next</a>
    </div>
</div>
