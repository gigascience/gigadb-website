...
Rosalind	Elsie	Franklin 	0000-0000-0000-0001	Conceptualization"
     ...
     <div style="text-align:center">
        <a href="/datasetSubmission/study/id/<?= $model->id ?>" class="btn-green">Previous</a>
         <a href="/datasetSubmission/author/id/<?= $model->id ?>" class="btn-green js-save-authors">Save</a>
        <a href="/datasetSubmission/additional/id/<?= $model->id ?>" class="btn-green js-save-authors">Next</a>
    </div>
...
function saveAuthors(url) {
    ...
    $.ajax({
        type: 'POST',
        url: '/adminDatasetAuthor/saveAuthors',
        data:{
