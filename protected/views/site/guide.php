                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        ...
                        <div class="subsection">
                            ...
                            <figure>
                                <img src="/images/workflow.png" alt="Workflow diagram of manuscript and data submission process for GigaScience" aria-describedby="workflowDescription"></img>
                                <figcaption>
                                    ...
                                    <div class="sr-only" id="workflowDescription">
                        ...
                        <div class="subsection">
                            ...
                            <br>
                            <div id="table_guide_submission" class="scrollbar table-responsive">
                            ...
                            <br>
                            <div id="table_guide_attribute" class="scrollbar table-responsive">
                                <table border="1" class="guide-table">
                                    <thead>
                                        <tr>
                                            <th class="col-30">
                            ...
                            <br>
                            <br>
                            <div id="table_guide_details" class="scrollbar table-responsive">
                                <table border="1" class="guide-table">
                                    <thead>
                                        <tr>
                                            <th class="col-20">
