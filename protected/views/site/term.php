        ...
        <section style="margin-bottom: 15px;">
            <div>
                <div class="tabs" role="tablist" aria-labelledby="pageTitle">
                    ...
                    <button id="liinformation" type="button" role="tab" aria-selected="false" aria-controls="information" data-toggle="tab" tabindex="-1">Collection of Web-traffic Information</button>
                    <button id="lipersonal" type="button" role="tab" aria-selected="false" aria-controls="personal" data-toggle="tab" tabindex="-1">Personal Data</button>
                </div>
            </div>
        </section>
        <section>
                ...
                <div role="tabpanel" class="tab-pane active" id="policies" tabindex="0" aria-labelledby="lipolicies">
                    ...
                    <div class="subsection">
                        ...
                        <p>Datasets associated with GigaScience journal articles are specifically released under a Creative
                            ...
                            for a data citation of each dataset is listed on each page. This is in accordance with the <a href="https://doi.org/10.25490/a97f-egyk">Data Citation Principles</a>. The Open Science
                    ...
                    <div class="subsection">
                        <p>As one of the world’s largest biological data producers, the BGI’s goal is to maximize the use of its
                            ...
                            in line with the <a href="http://www.genome.gov/10506537">Fort Lauderdale</a> and the <a href="http://www.nature.com/nature/journal/v461/n7261/full/461168a.html">Toronto
                        ...
                        <p>In recognition of the extensive effort that underlies these projects, we ask that you appropriately
                            ...
                            distribution and use of large-scale sequencing data: <a href="http://www.wellcome.ac.uk/About-us/Publications/Reports/Biomedical-science/WTD003208.htm">Community
                                Resource Projects</a> and the resulting <a href="http://www.genome.gov/page.cfm?pageID=10506537">NHGRI policy statement</a>. If you
                            have any questions regarding the use of this data, please contact us at <a href="mailto:database@gigasciencejournal.com">database@gigasciencejournal.com</a>. In line
