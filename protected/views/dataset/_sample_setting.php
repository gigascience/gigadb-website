            ...
            <div class="divForForm">
                <form id="sampleSettingsForm" name="mySamplesSettingform" method="POST">
                    ...
                    <div class="modal-body" style="padding: 30px;">
                        ...
                        <fieldset class="form form-inline" style="margin-bottom: 60px;">
                                <legend>Check columns to display</legend>


                                    <div class="checkbox">
                                        <input id="common_name" type="checkbox" name="columns[]" value="common_name"
                                        <?= (in_array("common_name", $columns))? "checked" : ""?>/><label for="common_name"><?= Yii::t('app','Common Name') ?></label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <?= (in_array("scientific_name", $columns))? "checked" : ""?>/><label for="scientific_name"><?= Yii::t('app','Scientific Name') ?></label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <?= (in_array("attribute", $columns))? "checked" : ""?>/><label for="sample_attribute"><?= Yii::t('app','Sample Attributes') ?></label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <?= (in_array("taxonomic_id", $columns))? "checked" : ""?>/><label for="taxonomic_id"><?= Yii::t('app','Taxonomic ID') ?></label>
                                    </div>


                                    <div class="checkbox">
                                        <input id="genbank_name" type="checkbox" name="columns[]" value="genbank_name"
                                        <?= (in_array("genbank_name", $columns))? "checked" : ""?>/><label for="genbank_name"><?= Yii::t('app','Genbank Name') ?></label>
                                    </div>
