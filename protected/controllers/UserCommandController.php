...
class UserCommandController extends CController
{
    ...
    public function actionClaim(int $dataset_id, int $author_id)
    {
        ...
        $existing_record = UserCommand::model()->findByAttributes(array('requester_id'  => $requester_id, 'actionable_id' => $actionable_id));
