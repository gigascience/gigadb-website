...
class GFtpResultParser 
{
	...
	function __construct()
	{
		...
		//parser
		$this->symbols_ = 		json_decode('{"error":2,"expressions":3,"e":4,"EOF":5,"EOL":6,"WORD":7,"SPACE":8,"$accept":0,"$end":1}', true);
		$this->terminals_ = 	json_decode('{"2":"error","5":"EOF","6":"EOL","7":"WORD","8":"SPACE"}', true);
		$this->productions_ = 	json_decode('[0,[3,2],[3,2],[4,1],[4,1],[4,2],[4,2]]', true);
		$this->table = 			json_decode('[{"3":1,"4":2,"7":[1,3],"8":[1,4]},{"1":[3]},{"5":[1,5],"6":[1,6]},{"4":7,"5":[2,3],"6":[2,3],"7":[1,3],"8":[1,4]},{"4":8,"5":[2,4],"6":[2,4],"7":[1,3],"8":[1,4]},{"1":[2,1]},{"1":[2,2]},{"5":[2,5],"6":[2,5]},{"5":[2,6],"6":[2,6]}]', true);
		$this->defaultActions = json_decode('{"5":[2,1],"6":[2,2]}', true);
		
		//lexer
		$this->rules = 			array("/^(?:\\s+)/","/^(?:\\S+)/","/^(?:[\\r\\n]+)/","/^(?:$)/");
...
break;
case 5:
		$thisS = array_merge(array($S[$O-1]), $S[$O]);
