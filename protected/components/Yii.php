...
# Generated by generate_config.sh. DO NOT EDIT DIRECTLY!

$yii2_path = getenv('YII2_PATH');
if (!class_exists('yii\BaseYii', false)) {
    require $yii2_path . '/BaseYii.php'; // Yii 2.x
}

$yii_path = getenv('YII_PATH');
if (!class_exists('YiiBase', false)) {
    require $yii_path . '/framework/YiiBase.php'; // Yii 1.x
}
...
class Yii extends \yii\BaseYii
{
    ...
    {
        return '1.1.20-yii2-2.0.15.1-migration';
    }
