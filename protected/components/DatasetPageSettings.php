...
class DatasetPageSettings extends yii\base\BaseObject
{
	...
	public function __construct(?Dataset $model, DatasetDAO $dao = null, $config = [])
	{
		...
		elseif ($this->_model && !$this->_model->isNewRecord && "Published" !== $this->_model->upload_status
	 ...
	 */
	public function getFileSettings(CMap $cookies = null, $defaultColumns = self::VIEW_DEFAULT_FILE_COLUMNS): array
	{
		// default values
		$fileSettings = [
