    ...
    */
    public function iAmLinkedToAuthor($author)
    {
        if ("Zhang, G" == $author) {
            ...
            // );
            $this->getMainContext()->getSubContext("AuthorUserContext")->authorIsAssociatedWithUser(3791,346);
        }
        else if("Yue, Z" == $author) {
            // return array(
            //     new Step\Given("author \"3798\" is associated with user \"346\""),
            // );
            $this->getMainContext()->getSubContext("AuthorUserContext")->authorIsAssociatedWithUser(3798,346);
        }
        else if("Pan, S" == $author) {
            // return array(
            //     new Step\Given("author \"3794\" is associated with user \"346\""),
            // );
            $this->getMainContext()->getSubContext("AuthorUserContext")->authorIsAssociatedWithUser(3794,346);
        }
    }
