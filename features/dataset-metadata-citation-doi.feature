...
Feature: Add the metadata schema on dataset page to allow Hypothesis to parse citation DOI
  ...
  Scenario: Go to dataset page and see DOI value
    ...
    And There should be a "meta" element with attribute "name" and value "citation_doi"
    And There should be a "meta" element with attribute "content" and value "10.5524/100002"
