...
Scenario: Metadata form elements for all uploaded files, but Save button inactive: none of the field for any file is filled in
	...
	And the button "Save Files Metadata" should not be active
...
Scenario: Saving all mandatory metadata for some files: allowed, but not allowed to click Complete... until all files are done
	Given I have uploaded a set of files to the drop box for dataset "100006"
	And I am on the file metadata page
	When I fill in "file-1-data-type" with "Text"
	And I fill in "file-1-description" with "this is file description for file 1"
...
Scenario: Saving some mandatory metadata for some files is not allowed
	...
	And I fill in "file-1-description" with "this is file description for file 1"
	And I fill in "file-2-data-type" with "Text"
	Then the button "Save Files Metadata" should not be active
	And I should not see the button "Complete and return to Your Uploaded Datasets page"
