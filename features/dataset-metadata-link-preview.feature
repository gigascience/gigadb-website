...
Feature: Add the metadata schema on dataset page to allow other web sites to make link previews of our web site
  ...
  @wip @issue-513
    ...
    Then there should be a "name" meta tag "title" with value "GigaDB Dataset - DOI 10.5524/100002 - Genomic data from Adelie penguin (Pygoscelis adeliae)."
    And there should be a "name" meta tag "description" with lines:
    """
