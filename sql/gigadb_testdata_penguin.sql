...
SELECT pg_catalog.setval('dataset_author_id_seq', 3480, true);
...
SELECT pg_catalog.setval('dataset_id_seq', 210, true);
...
SELECT pg_catalog.setval('dataset_log_id_seq', 83, true);
...
SELECT pg_catalog.setval('dataset_sample_id_seq', 4354, true);
...
SELECT pg_catalog.setval('dataset_type_id_seq', 255, true);
...
SELECT pg_catalog.setval('file_type_id_seq', 111, true);
...
SELECT pg_catalog.setval('image_id_seq', 222, true);
...
SELECT pg_catalog.setval('sample_id_seq', 4346, true);
...
SELECT pg_catalog.setval('species_id_seq', 1128854, true);
...
SELECT pg_catalog.setval('type_id_seq', 25, true);
