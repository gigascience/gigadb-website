...
- Fix #1746: FUW - Update existing vue component tests and add test coverage for new components
- Feat #1632: FUW - Show list of selectable attributes in metadata editor
